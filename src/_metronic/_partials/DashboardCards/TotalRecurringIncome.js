...
import { getRecurringIncomeAsync } from '../../../app/actions/dashboard.action';
...
const TotalRecurringIncome = () => {
    ...
    const { recurringIncome } = useSelector(state => state.dashboard)

    useEffect(() => {
        dispatch(getRecurringIncomeAsync(date))
    }, [date])
                ...
                <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                        ...
                        <div className="row_data">
                            <div className="h4 mb-0 font-weight-bold text-gray-800">${parseFloat(recurringIncome).toFixed(2)}</div>
                            <Form.Control
                                as="select"
                                defaultValue={date}
...
export default TotalRecurringIncome;
