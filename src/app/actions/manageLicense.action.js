...
export const addLicenseAsync = (data) => {
  return async (dispatch) => {
    try {
      ...
      // start - commented below addLicenseResponse - warning - assigned value but never used.
      //   let addLicenseResponse = await axios({
      //     url: `http://127.0.0.1:4000/api/license/addLicense`,
      //     method: 'POST',
      //     headers: {
      //       tokens:
      //         'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI1ZjMyNTBiZDcxYzA0OTQxODI3ZTIzZWIiLCJlbWFpbCI6ImFkbWluQHJvcy5vcmciLCJyb2xlIjoiQURNSU4iLCJpYXQiOjE2MDAxNzUzNjEsImV4cCI6MTYwNDQwODk2MX0.3KanH2yrWLNaDmi-wlAB_N8szAE1uxEikH93DrPrhf0',
      //       'Content-Type': 'application/json',
      //     },
      //     data,
      //   });
      // end - commented above addLicenseResponse - warning - assigned value but never used.
